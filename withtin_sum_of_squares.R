...
sm5<-kkmeans(Allpara_nazero, centers=7)
sm6<-kkmeans(Allpara_nazero, centers=8)
sm7<-kkmeans(Allpara_nazero, centers=9)
sm8<-kkmeans(Allpara_nazero, centers=10)
sm9<-kkmeans(Allpara_nazero, centers=11)
    ...
    wss[5]<-sum(withinss(sc))
    wss[6]<-sum(withinss(sm5))
wss[7]<-sum(withinss(sm6))
wss[8]<-sum(withinss(sm7))
wss[9]<-sum(withinss(sm8))
